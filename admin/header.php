...
<body>
  <header>
    <div class="logo">
      <img src="../img/kunai_logo.png " alt="">
    </div>
  </header>
  <div class="panel">
    <?php
      ...
      <a href="edit_categ.php" class="panel__btn">Редактирование категорий</a>
    </div>
    <div class="panel__item panel__reg">
      <span class="panel__icon"><img src="../img/icons/Tilda_Icons_7cafe_burger.svg" alt=""></span>
      <a href="edit_dish.php" class="panel__btn">Редактирование товаров</a>
    </div>
    <div class="panel__item panel__reg">
      <span class="panel__icon"><img src="../img/icons/man.svg" alt=""></span>
      <a href="edit_clients.php" class="panel__btn">Клиенты</a>
    </div>
    <div class="panel__item panel__reg">
      <span class="panel__icon"><img src="../img/icons/man.svg" alt=""></span>
      <a href="edit_employees.php" class="panel__btn">Сотрудники</a>
    </div>
    <div class="panel__item panel__reg">
